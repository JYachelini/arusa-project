import { Box, Container, Typography, useMediaQuery, TextField } from '@mui/material'
...
function ContactUs() {
	...
	return (
		...
		>
			<Box component='img' src={matches ? Image : ImageMobile} sx={{ width: '100%' }} />
			<Box
				sx={{
					position: 'absolute',
					top: '0',
			...
			>
				<Typography sx={{ typography: 'h2', color: 'cloudy.main', maxWidth: '60%' }}>
