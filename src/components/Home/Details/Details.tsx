...
function Details() {
	...
	const articlesPresentation = {
		...
		subtitle: 'WE ARE SPECIALIZED IN ADORNMENTS, THAT BRING CHARM TO ANY ENVIRONMENT.',
		description:
