...
function Presentation({
	...
	return (
		...
		>
			...
			>
				<Typography
					sx={{ typography: { mobile: 'h4', laptop: 'h3' }, color: 'cloudy.main', paddingTop: '3rem' }}
				>
					{title}
				</Typography>
				<Typography
					sx={{ typography: 'regular', color: 'oyster.main', paddingBottom: { laptop: '15rem' } }}
				>
					{description}
				</Typography>
			</Box>
			...
			>
				...
				>
					...
					>
						Materials:
						<Typography component={'span'} sx={{ typography: 'small', textTransform: 'uppercase' }}>
				...
				>
					<Box component='img' src={product.imageUrl} sx={{ maxHeight: '80%' }}></Box>
